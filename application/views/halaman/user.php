                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="<?php echo base_url();?>index.php/halaman/tambah_user">
...
if( ! empty($gambar)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
  ...
  //   echo "</tr>";
    ...
    echo "<td>".$data->alamat."</td>";
    echo "<td><img src='".base_url("gambar/".$data->nama_file)."' width='50' height='50'></td>";
    echo "<td><a href='".site_url("halaman/edit_user/".$data->id)."'> "
    ."<button type='submit' class='btn bg-cyan btn-xs waves-effect' data-type='confirm'><i class='material-icons'>edit</i></button>"
    ."</a> 
    <a class='hapus-link' href='".site_url("halaman/delete_user/".$data->id)."'> "
    ."<button onclick='return confirm('Yakin data ".$data->username." ingin di hapus??')' type='submit' class='btn btn-danger btn-xs waves-effect' data-type='confirm'><i class='material-icons'>delete</i></button>"
    ."</a>";
    // echo "</tr>";
