<div class="menu">
                <ul class="list">
                    ...
                    <li <?php if($act==1){?>class="active"<?php } ?>>
                        <a href="<?php echo base_url();?>index.php/sch_adm/beranda">
                   ...
                   <!-- <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo base_url();?>index.php/halaman/tulis">
                                    <span>Tulis</span>
                                </a>
                            </li>
                            <li>
                    ...
                    <li <?php if($act==2){?>class="active"<?php } ?>>
                        <a href="<?php echo base_url();?>index.php/sch_adm/guru_adm">
                            <i class="material-icons">person_pin</i>
                            <span>Guru</span>
                        </a>
                    </li>
                    <li <?php if($act==3){?>class="active"<?php } ?>>
                        <a href="<?php echo base_url();?>index.php/sch_adm/sekolah_adm">
